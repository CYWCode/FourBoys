<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Web.Unsigned.FrontPage" %>
...
<div class="navbar navbar-default navbar-fixed-top">
	...
	<div id="carousel1" class="carousel slide" data-ride="carousel" style="margin: 30px 0 20px 0;">
		<div class="carousel-inner">
			<div class="item active">
				<img src="./Resource_files/indexbg.png">
				<div class="container">
					<div class="col-md-12 index-content">
						<div class="col-md-7">
			                  ...
			                  <a href="signup.aspx" target="_blank" class="btn btn-lg btn-success">开通免费版</a>
			                  <div class="clearfix"></div>
		          	    </div>
						<div class="col-md-5 hidden-xs hidden-md">
							<img src="./Resource_files/indexicon.png">
						</div>
					</div>
				</div>
			</div>
	...
	<div class="corp-num">
		<div class="container">
			...
			<div>
				<a href="customer_case.aspx" class="btn btn-lg btn-info">看看谁在用猿圈</a>
			</div>
		</div>
	</div>
	<div id="carousel2" class="container carousel slide corp-comment" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item">
				<dl>
					<dt>
						<img src="./Resource_files/51shebaohr.png" width="80px" height="80px">
						<span>51社保HR</span>
					</dt>
					<dd>
			...
			<div class="item active left">
				<dl>
					<dt>
						<img src="./Resource_files/huanxinhr.png" width="80px" height="80px">
						<span>环信HR</span>
					</dt>
					<dd>
			...
			<div class="item next left">
				<dl>
					<dt>
						<img src="./Resource_files/kaiyuanhr.png" width="80px" height="80px"><span>开源中国HR</span>
					</dt>
					<dd>
