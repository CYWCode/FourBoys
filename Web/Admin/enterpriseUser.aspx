<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="enterpriseUser.aspx.cs" Inherits="Web.Admin.enterpriseUser" %>
        ...
        <div class="col-md-8 col-no-left-padding col-md-offset-2">
            <asp:Table ID="tableUser" runat="server" CssClass="table table-hover">
                <asp:TableHeaderRow ID="tableUserHeader" >
                    ...
                    <asp:TableHeaderCell >企业全称</asp:TableHeaderCell>
                    <asp:TableHeaderCell >企业简称</asp:TableHeaderCell>
                    <asp:TableHeaderCell >企业规模</asp:TableHeaderCell>
