<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false"  CodeBehind="EnterpriseHP.aspx.cs" Inherits="Web.EnterpriseInfor_kui.EnterpriseHP" %>

<!DOCTYPE html>
<!-- saved from url=(0053)http://www.oxcoder.com/cooper/oxcoder_corp_index.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><script id="stat_script" src="./猿圈 企业首页_files/stat.php" charset="utf-8"></script><script id="ivt_script" src="./猿圈 企业首页_files/kf_ivt_new.php" charset="utf-8"></script><script id="hz6d_send_acc" src="./猿圈 企业首页_files/sendacc.jsp" charset="utf-8"></script>
...
<title>猿圈 企业首页</title>
<link href="./猿圈 企业首页_files/bootstrap.min.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/font-awesome.min.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/bootstrap-switch.min.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/bootstrap-select.min.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/style.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/summernote.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/summernote-bs3.css" rel="stylesheet">
<link href="./猿圈 企业首页_files/style(1).css" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="./猿圈 企业首页_files/bootstrapValidator.min.css">
<!-- Max css -->
<link href="./猿圈 企业首页_files/style_new.css" rel="stylesheet" type="text/css">
        <style type="text/css">
        .sub-action{
          ...
          <!-- <div class="col-md-12 top shadow-effect">
            ...
            <div class="col-md-12 top shadow-effect">
                    <li class="col-md-4 stat" style="text-align:center;">
                        <ul>
                            <h1 style="font-size:100px;"><a href="http://www.oxcoder.com/cooper/index.html">1</a></h1>
                            <li>正在发布中的挑战</li>
                            <li>还可发布的挑战：<span class="badge badge-info">0</span>个</li>
                            <li class="mcButton">
                                <a href="http://www.oxcoder.com/cooper/new/recruit/new_recruit_1.html" class="btn btn-new1">新增挑战邀请</a>
                            </li>
                        </ul>
                    </li>
                    <li class="col-md-4 stat" style="text-align:center;">
                        <ul>
                          <h1 style="font-size:100px;"><a href="http://www.oxcoder.com/cooper/index.html">0</a></h1>
                            ...
                            <li class="mcButton">
                                <a href="http://www.oxcoder.com/cooper/index.html" class="btn btn-new1">查看挑战报告</a>
                            </li>
                        </ul>
                    </li>
                    <li class="col-md-4 stat" style="text-align:center;">
                        <ul>
                          <h1 style="font-size:100px;"><a href="http://www.oxcoder.com/cooper/recommended/talent/index.html">10</a></h1>
                            <li>剩余猿民币：</li>
                            <li>为您推荐人才：<span class="badge badge-info">10+</span>个</li>
                            <li class="mcButton">
                                <a href="http://www.oxcoder.com/cooper/recommended/talent/index.html" class="btn btn-new1">查看推荐人才</a>
                            </li>
                        </ul>
                    </li>
            </div>
            ...
            <div class="col-md-12 ac-group shadow-effect">
              <div class="panel panel-default" style="margin-bottom:0;">
                  ...
                  <div class="panel-heading">
                      <h3 class="panel-title"><img src="./猿圈 企业首页_files/recommend.png">人才推荐</h3>
                  </div>
                  <div class="panel-body">
                      <a href="http://www.oxcoder.com/cooper/recommended/talent/index.html" class="sub-action">人才推荐</a><a href="http://www.oxcoder.com/cooper/recommended/talent/index.html?isViewedTalent=true" class="sub-action">已查看人才</a>
                  </div>
                  <div class="panel-heading">
          ...
          <div class="panel-user">
            <div class="panel-heading">
              <div class="panel-title">
                <div class="media">
                  <a class="pull-left">
                    <img src="./猿圈 企业首页_files/50a7fbf8-d4fa-487a-805a-52a707a00511.png" class="media-object">
                  </a>
...
<script type="text/javascript" src="./猿圈 企业首页_files/kf.php"></script>




<script id="hz6d_flp_jquery" src="./猿圈 企业首页_files/jquery-1.4.2.flp.js" charset="utf-8" type="text/javascript"></script></body></html>
